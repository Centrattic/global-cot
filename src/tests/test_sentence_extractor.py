...
def test_extract_sentences():
    ...
    print(
        f"Expected: ['Hello world!', 'How are you today?', 'I am doing very well.']"
    )
    print()
    ...
    print(
        f"Expected: ['What do you think?!', 'Really, is that so?!!', 'Yes, I believe it is.']"
    )
    print()
    ...
    print(
        f"Expected: ['This is a very long sentence that should remain as is. Short.', 'Another long sentence with multiple clauses and complex structure. OK. Final sentence here.']"
    )
    print()
    ...
    print(
        f"Expected: ['This is just one long sentence without any punctuation']"
    )
    print()
    ...
    print(
        f"Expected: ['The quick brown fox jumps over the lazy dog.', 'Wow!', 'Is that true?', 'Absolutely not. The dog is actually quite active.']"
    )
    print()
    ...
    print(
        f"Expected: ['Hello world! How are you? Fine.'] (all merged due to short sentences)"
    )
    print()
